          ...
          return `<div class="story-viewer">
                    <div class="head">
                      ...
                      <div class="right">
                        ...
                        <a class="play_story poppins-light" style="display:none";><i id="zuckfa" class="far fa-play-circle fa-2x" aria-hidden="true"></i> PLAY/a>
                        &nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    ${
                       ...
                       ? `<div class="L_story_social">
                            <ul class="list-inline">
                              ...
                              <li class="list-inline-item"><a href="#" class="tip copy" onclick="javascript:CopyToClipboard();">COPY LINK</a></li></ul></div>`
                      : ''
                    }
                  </div>`;
        }
